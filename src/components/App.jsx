...
// --- Definições dos Componentes Simples (Se não quiser criar arquivos separados) ---
// Se você for usar arquivos separados (melhor prática), remova estas definições
const Header = () => {
...
const BookList = ({ books, onRemoveBook }) => (
    <ul className="book-list">
        {books.map(book => (<BookItem key={book.id} book={book} onRemove={onRemoveBook} />))}
    </ul>
);
